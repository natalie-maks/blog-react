  ...
  return (
    <section className="mt-12 w-full sm:w-1/2 lg:w-full">
      ...
      <ul className="flex justify-between mt-6">
        <li className="mb-1 w-14 h-14 lg:w-11 lg:h-11 xl:w-14 xl:h-14 p-3 border-2 border-black hover:bg-yellow-200 transition-all">
        ...
        <li className="w-14 h-14 lg:w-11 lg:h-11 xl:w-14 xl:h-14 p-3 border-2 border-black hover:bg-yellow-200 transition-all">
